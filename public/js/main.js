let setOverflow = document.querySelector('.main-header__label');
let closeButton = document.querySelector('.main-modal__close');
let modal = document.querySelector('.main-header__main-modal-container');
let checkbox = document.querySelector('.main-nav-toggle2');
...
const escKey = document.addEventListener('keyup', e => {
    if (e.key == "Escape") {closeModal();}
})

setOverflow.addEventListener('click', () => {
